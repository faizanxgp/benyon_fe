                ...
                <div className="m-auto w-full max-w-[420px] xs:max-w-[520px] p-5">
                    ...
                    <div className="border border-gray-300 dark:border-gray-900 rounded p-5 sm:p-6 md:p-10">
                        ...
                        <form action="#">                            <Form.Group>
                            ...
                            <Form.Group>
                                <Button as="Link" to="/auths/auth-success-v2" size="lg" variant="primary" block>Send Reset Link</Button>
                            </Form.Group>
                        </form>
                        <div className="pt-6 text-center"> 
                            <Link className="text-primary-500 hover:text-primary-600 font-medium transition-all duration-300" to="/auths/auth-login-v2">Return to login</Link>
                        </div>
                    </div>
                </div>
