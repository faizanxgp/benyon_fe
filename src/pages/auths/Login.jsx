        ...
        <div className="relative flex min-h-screen">
            <div className="relative flex flex-col min-h-full bg-white dark:bg-gray-950 w-full lg:w-[45%] flex-shrink-0">
                ...
                <div className="m-auto w-full max-w-[420px] p-5 2xl:me-[90px]">
                    ...
                    <form action="#">
                        ...
                        <Form.Group>
                            <Form.Label className="flex justify-between items-center mb-2" htmlFor="password">
                                <span>Passcode </span>
                                <Link to="/auths/auth-reset" className="inline-flex text-xs leading-none whitespace-nowrap transition-all duration-300 font-medium font-body text-primary-500 hover:text-primary-600">Forgot Code?</Link>
                            </Form.Label>
                            <Input.Wrap>
                    ...
                    <div className="pt-6"> 
                        New on our platform? 
                        <Link className="text-primary-500 hover:text-primary-600 transition-all duration-300" to="/auths/auth-register"> Create an account</Link>
                    </div>
                    ...
                    <div className="text-center mt-10">
                        ...
                        <Link className="text-primary-500 hover:text-primary-600 transition-all duration-300" to="/auths/auth-register"> Try 15 days free</Link> 
                    </div>
                </div>
