...
// Original static menuData (commented out)
// const menuData = [
//     { heading: "Dashboards" },
...
//     { icon: "signin", text: "Login", link: "/auths/auth-login-v2" },
// ]
...
const Menu = ({setSidebarVisibility}) => {
    ...
    const [dashboardHeading, setDashboardHeading] = useState('Dashboard');
    const [menuData, setMenuData] = useState([]);
    
    // Update dashboard heading based on user role
    const updateDashboardHeading = () => {
        const heading = getDashboardHeading();
        setDashboardHeading(heading);
        setMenuData(getMenuData(heading));
    };
      // Listen for login events to update the heading
    useEffect(() => {
        ...
        const handleUserLogout = () => {
            // Reset to default heading when user logs out
            setDashboardHeading('Dashboard');
            setMenuData(getMenuData('Dashboard'));
        };
        
        // Update heading on component mount
        updateDashboardHeading();
